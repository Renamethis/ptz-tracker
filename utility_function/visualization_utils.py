...
def visualize_boxes_and_labels_on_image_array(
  ...
  for box, color in box_to_color_map.items():
    ...
    test_list.append(str(category_index[classes[count]]['name']))
    test_list.append(int(100*scores[count]))
    test_list.append(xmax)
    test_list.append(ymax)
    test_list.append(xmin)
    test_list.append(ymin)
    count += 1
    #test_list.append()
