...
os.system('sudo pip install tensorflow==2.0.0')
...
os.system('sudo pip install libsm6 libxext6')
...
os.system('sudo cp  ' + os.getcwd() + '/ssd_mobilenet_v2_coco_2018_03_29.tar.gz ' + os.getcwd() + '/models/research/object_detection')
